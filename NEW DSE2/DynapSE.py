...
class DynapSE:
    ...
    def add_connection(self, NeuronGroup1, NeuronGroup2, synapse_type='NMDA'):
        ...
        '''
        assert synapse_type in ['NMDA', 'AMPA', 'AMPA_STD', 'GABA_A','GABA_B'],'Please provide a valid synapse type.'
        ...
        elif synapse_type == 'AMPA_STD':
            synapse = Synapses(NeuronGroup1, NeuronGroup2,
                    **dynapse_ampa_std_syn_eq(), name='AMPA_STD'+str(self.num_connections))
