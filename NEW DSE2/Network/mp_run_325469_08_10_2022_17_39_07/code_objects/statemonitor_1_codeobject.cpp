...
const size_t _num_sub_idx = 6;
    ...
    int32_t* __restrict  _ptr_array_Core_2_subgroup_2__sub_idx = _array_Core_2_subgroup_2__sub_idx;
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_Core_2_subgroup_2__sub_idx[_idx];
