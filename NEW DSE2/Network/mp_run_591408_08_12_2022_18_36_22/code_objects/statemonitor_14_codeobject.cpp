...
const size_t _num_sub_idx = 4;
    ...
    int32_t* __restrict  _ptr_array_Core_3_subgroup_1__sub_idx = _array_Core_3_subgroup_1__sub_idx;
    ...
    _dynamic_array_statemonitor_14_Isoma_mem.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_Core_3_subgroup_1__sub_idx[_idx];
        const double _source_Isoma_mem = _ptr_array_Core_3_Isoma_mem[_sub_idx];
        const double _to_record_Isoma_mem = _source_Isoma_mem;


        _dynamic_array_statemonitor_14_Isoma_mem(_new_size-1, _i) = _to_record_Isoma_mem;
    }
