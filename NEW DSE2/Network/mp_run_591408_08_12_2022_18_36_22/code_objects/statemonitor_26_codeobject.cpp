...
void _run_statemonitor_26_codeobject()
{
...
const size_t _num_postsynaptic_idx = _dynamic_array_GABA_B9__synaptic_post.size();
    ...
    _dynamic_array_statemonitor_26_Igaba_b.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        _dynamic_array_statemonitor_26_Igaba_b(_new_size-1, _i) = _to_record_Igaba_b;
    }
