...
int main(int argc, char **argv)
{
...

	{
        ...
        _run_AMPA0_synapses_create_generator_codeobject_1();
        _run_AMPA_STD1_synapses_create_generator_codeobject_1();
        _run_AMPA2_synapses_create_generator_codeobject_1();
        _run_AMPA3_synapses_create_generator_codeobject_1();
        _run_GABA_B4_synapses_create_generator_codeobject_1();
        _run_GABA_B5_synapses_create_generator_codeobject_1();
        _run_GABA_B6_synapses_create_generator_codeobject_1();
        _run_AMPA7_synapses_create_generator_codeobject_1();
        _run_AMPA_STD8_synapses_create_generator_codeobject_1();
        _run_GABA_B9_synapses_create_generator_codeobject_1();
        _run_GABA_B10_synapses_create_generator_codeobject_1();
                        ...
                        {
                            _dynamic_array_AMPA3_weight[i] = 15;
                        }
                        ...
                        {
                            _dynamic_array_AMPA_STD8_weight[i] = 12;
                        }
        ...
        _array_Core_1_Isoma_th[0] = 2e-10;
        ...
        _array_Core_1_Isoma_ahp_tau[0] = 3e-12;
                        ...
                        for(int i=0; i<_num__array_Core_1_alpha_ahp; i++)
                        {
                            _array_Core_1_alpha_ahp[i] = 2;
                        }
                        
        _array_Core_1_soma_refP[0] = 0.01;
        ...
        _array_Core_2_Isoma_th[0] = 3.0000000000000004e-09;
        
                        
                        for(int i=0; i<_num__array_Core_2_alpha_soma; i++)
                        {
                            _array_Core_2_alpha_soma[i] = 2.7;
                        }
                        
        _array_Core_2_Isoma_ahp_tau[0] = 0.0;
        ...
        _array_Core_2_soma_refP[0] = 0.0025;
        
                        
                        for(int i=0; i<_num__array_Core_2_Isoma_const; i++)
                        {
                            _array_Core_2_Isoma_const[i] = 1.5e-10;
                        }
        ...
        _array_Core_3_soma_refP[0] = 0.002;
                        ...
                        for(int i=0; i<_num__array_Core_2_Iampa_std_tau; i++)
                        {
                            _array_Core_2_Iampa_std_tau[i] = 1e-11;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_2_tau_pulse; i++)
                        {
                            _array_Core_2_tau_pulse[i] = 0.003;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_2_Idischarge_w; i++)
                        {
                            _array_Core_2_Idischarge_w[i] = 5e-12;
                        }
                        ...
                        for(int i=0; i<_num__array_statemonitor_16__indices; i++)
                        {
                            _array_statemonitor_16__indices[i] = _static_array__array_statemonitor_16__indices[i];
                        }
        ...
        _array_statemonitor_27__indices[0] = 0;
        ...
        network_1.add(&defaultclock, _run_statemonitor_26_codeobject);
        network_1.add(&defaultclock, _run_statemonitor_27_codeobject);
        ...
        network_1.add(&defaultclock, _run_SpikeGenerator_codeobject_2);
        ...
        network_1.add(&defaultclock, _run_AMPA0_pre_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA2_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA2_pre_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA3_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA3_pre_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA7_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA7_pre_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA_STD1_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD1_pre_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA_STD8_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD8_pre_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B10_pre_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B10_pre_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B4_pre_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B4_pre_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B5_pre_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B5_pre_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B6_pre_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B6_pre_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B9_pre_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B9_pre_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA0_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA0_post_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA2_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA2_post_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA3_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA3_post_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA7_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA7_post_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA_STD1_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD1_post_codeobject_2);
        network_1.add(&defaultclock, _run_AMPA_STD8_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD8_post_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B10_post_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B10_post_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B4_post_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B4_post_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B5_post_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B5_post_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B6_post_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B6_post_codeobject_2);
        network_1.add(&defaultclock, _run_GABA_B9_post_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B9_post_codeobject_2);
        ...
        #ifdef DEBUG
        _debugmsg_AMPA0_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA2_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA3_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA7_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD1_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD8_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B10_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B4_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B5_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B6_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B9_pre_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA0_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA2_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA3_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA7_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD1_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD8_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B10_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B4_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B5_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B6_post_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B9_post_codeobject_2();
        #endif
