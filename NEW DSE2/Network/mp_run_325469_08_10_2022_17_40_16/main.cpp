...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(30);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(30);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(30);
        ...
        _run_GABA_B10_synapses_create_generator_codeobject();
                        ...
                        {
                            _dynamic_array_AMPA3_weight[i] = 20;
                        }
