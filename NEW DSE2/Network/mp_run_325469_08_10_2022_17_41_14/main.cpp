...
int main(int argc, char **argv)
{
...

	{
        ...
        _run_GABA_B10_synapses_create_generator_codeobject();
                        ...
                        {
                            _dynamic_array_AMPA3_weight[i] = 18;
                        }
        ...
        network.add(&defaultclock, _run_statemonitor_10_codeobject);
        network.add(&defaultclock, _run_statemonitor_11_codeobject);
        ...
        network.add(&defaultclock, _run_statemonitor_6_codeobject);
        network.add(&defaultclock, _run_statemonitor_7_codeobject);
        network.add(&defaultclock, _run_statemonitor_8_codeobject);
        network.add(&defaultclock, _run_statemonitor_9_codeobject);
        ...
        network.add(&defaultclock, _run_SpikeGenerator_codeobject_1);
        ...
        network.add(&defaultclock, _run_AMPA0_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA2_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA2_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA3_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA3_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA7_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA7_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA_STD1_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA_STD1_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA_STD8_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA_STD8_pre_codeobject_1);
        network.add(&defaultclock, _run_GABA_B10_pre_push_spikes);
        network.add(&defaultclock, _run_GABA_B10_pre_codeobject_1);
        network.add(&defaultclock, _run_GABA_B4_pre_push_spikes);
        network.add(&defaultclock, _run_GABA_B4_pre_codeobject_1);
        network.add(&defaultclock, _run_GABA_B5_pre_push_spikes);
        network.add(&defaultclock, _run_GABA_B5_pre_codeobject_1);
        network.add(&defaultclock, _run_GABA_B6_pre_push_spikes);
        network.add(&defaultclock, _run_GABA_B6_pre_codeobject_1);
        network.add(&defaultclock, _run_GABA_B9_pre_push_spikes);
        network.add(&defaultclock, _run_GABA_B9_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA0_post_push_spikes);
        network.add(&defaultclock, _run_AMPA0_post_codeobject_1);
        network.add(&defaultclock, _run_AMPA2_post_push_spikes);
        network.add(&defaultclock, _run_AMPA2_post_codeobject_1);
        network.add(&defaultclock, _run_AMPA3_post_push_spikes);
        network.add(&defaultclock, _run_AMPA3_post_codeobject_1);
        network.add(&defaultclock, _run_AMPA7_post_push_spikes);
        network.add(&defaultclock, _run_AMPA7_post_codeobject_1);
        network.add(&defaultclock, _run_AMPA_STD1_post_push_spikes);
        network.add(&defaultclock, _run_AMPA_STD1_post_codeobject_1);
        network.add(&defaultclock, _run_AMPA_STD8_post_push_spikes);
        network.add(&defaultclock, _run_AMPA_STD8_post_codeobject_1);
        network.add(&defaultclock, _run_GABA_B10_post_push_spikes);
        network.add(&defaultclock, _run_GABA_B10_post_codeobject_1);
        network.add(&defaultclock, _run_GABA_B4_post_push_spikes);
        network.add(&defaultclock, _run_GABA_B4_post_codeobject_1);
        network.add(&defaultclock, _run_GABA_B5_post_push_spikes);
        network.add(&defaultclock, _run_GABA_B5_post_codeobject_1);
        network.add(&defaultclock, _run_GABA_B6_post_push_spikes);
        network.add(&defaultclock, _run_GABA_B6_post_codeobject_1);
        network.add(&defaultclock, _run_GABA_B9_post_push_spikes);
        network.add(&defaultclock, _run_GABA_B9_post_codeobject_1);
