...
const size_t _numUt = 1;
    ...
    double* __restrict  _ptr_array_Core_3_Iampa_std = _array_Core_3_Iampa_std;
    double*   _ptr_array_Core_3_Csoma_mem = _array_Core_3_Csoma_mem;
    double* __restrict  _ptr_array_Core_3_alpha_ampa_std = _array_Core_3_alpha_ampa_std;
    double* __restrict  _ptr_array_Core_3_Igaba_a = _array_Core_3_Igaba_a;
    double* __restrict  _ptr_array_Core_3_Vw = _array_Core_3_Vw;
    ...
    double* __restrict  _ptr_array_Core_3_Iampa_std_tau = _array_Core_3_Iampa_std_tau;
    double* __restrict  _ptr_array_Core_3_Isoma_const = _array_Core_3_Isoma_const;
    double* __restrict  _ptr_array_Core_3_tau_pulse = _array_Core_3_tau_pulse;
    double* __restrict  _ptr_array_Core_3_alpha_gaba_b = _array_Core_3_alpha_gaba_b;
    ...
    double* __restrict  _ptr_array_Core_3_std_pulse = _array_Core_3_std_pulse;
    ...
    double* __restrict  _ptr_array_Core_3_Va = _array_Core_3_Va;
    double* __restrict  _ptr_array_Core_3_Campa_std = _array_Core_3_Campa_std;
    double* __restrict  _ptr_array_Core_3_Idischarge_w = _array_Core_3_Idischarge_w;
    ...
    double* __restrict  _ptr_array_Core_3_alpha_soma = _array_Core_3_alpha_soma;
    ...
    double* __restrict  _ptr_array_Core_3_alpha_nmda = _array_Core_3_alpha_nmda;
    double* __restrict  _ptr_array_Core_3_alpha_ahp = _array_Core_3_alpha_ahp;
    double* __restrict  _ptr_array_Core_3_Inmda_thr = _array_Core_3_Inmda_thr;
    ...
    double* __restrict  _ptr_array_Core_3_alpha_gaba_a = _array_Core_3_alpha_gaba_a;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double Iampa_std = _ptr_array_Core_3_Iampa_std[_idx];
        const double alpha_ampa_std = _ptr_array_Core_3_alpha_ampa_std[_idx];
        double Igaba_a = _ptr_array_Core_3_Igaba_a[_idx];
        double Vw = _ptr_array_Core_3_Vw[_idx];
        const double Iampa_tau = _ptr_array_Core_3_Iampa_tau[_idx];
        const double Cgaba_a = _ptr_array_Core_3_Cgaba_a[_idx];
        const double Iampa_std_tau = _ptr_array_Core_3_Iampa_std_tau[_idx];
        const double tau_pulse = _ptr_array_Core_3_tau_pulse[_idx];
        const double Isoma_const = _ptr_array_Core_3_Isoma_const[_idx];
        const double alpha_gaba_b = _ptr_array_Core_3_alpha_gaba_b[_idx];
        double std_pulse = _ptr_array_Core_3_std_pulse[_idx];
        const double Inmda_tau = _ptr_array_Core_3_Inmda_tau[_idx];
        double Inmda = _ptr_array_Core_3_Inmda[_idx];
        const double Va = _ptr_array_Core_3_Va[_idx];
        const double Campa_std = _ptr_array_Core_3_Campa_std[_idx];
        const double Idischarge_w = _ptr_array_Core_3_Idischarge_w[_idx];
        double Iampa = _ptr_array_Core_3_Iampa[_idx];
        const double Igaba_b_tau = _ptr_array_Core_3_Igaba_b_tau[_idx];
        const double alpha_soma = _ptr_array_Core_3_alpha_soma[_idx];
        ...
        const double alpha_nmda = _ptr_array_Core_3_alpha_nmda[_idx];
        const double alpha_ahp = _ptr_array_Core_3_alpha_ahp[_idx];
        const double Inmda_thr = _ptr_array_Core_3_Inmda_thr[_idx];
        ...
        const double alpha_ampa = _ptr_array_Core_3_alpha_ampa[_idx];
        const double alpha_gaba_a = _ptr_array_Core_3_alpha_gaba_a[_idx];
        ...
        _ptr_array_Core_3_Iampa_std[_idx] = Iampa_std;
        ...
        _ptr_array_Core_3_std_pulse[_idx] = std_pulse;
        _ptr_array_Core_3_Vw[_idx] = Vw;
