...
void _run_statemonitor_16_codeobject()
{
    using namespace brian;


    ///// CONSTANTS ///////////
    const size_t _num_indices = 40;
...
const size_t _num_sub_idx = 40;
    ///// POINTERS ////////////
        
    int32_t* __restrict  _ptr_array_statemonitor_16__indices = _array_statemonitor_16__indices;
    ...
    _dynamic_array_statemonitor_16_t.push_back(_ptr_array_defaultclock_t[0]);

    const size_t _new_size = _dynamic_array_statemonitor_16_t.size();
    // Resize the dynamic arrays
    _dynamic_array_statemonitor_16_Isoma_mem.resize(_new_size, _num_indices);
    ...
    {
        // vector code
        const size_t _idx = _ptr_array_statemonitor_16__indices[_i];
        ...
        _dynamic_array_statemonitor_16_Isoma_mem(_new_size-1, _i) = _to_record_Isoma_mem;
    }

    _ptr_array_statemonitor_16_N[0] = _new_size;
