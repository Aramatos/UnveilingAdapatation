...
void _run_Core_1_stateupdater_1_codeobject()
{
...
const size_t _numt = 1;
    ...
    double*   _ptr_array_Core_1_Isoma_pfb_gain = _array_Core_1_Isoma_pfb_gain;
    double* __restrict  _ptr_array_Core_1_Isoma_ahp = _array_Core_1_Isoma_ahp;
    double* __restrict  _ptr_array_Core_1_Igaba_a = _array_Core_1_Igaba_a;
    double* __restrict  _ptr_array_Core_1_Isoma_const = _array_Core_1_Isoma_const;
    double*   _ptr_array_Core_1_soma_refP = _array_Core_1_soma_refP;
    char* __restrict  _ptr_array_Core_1_not_refractory = _array_Core_1_not_refractory;
    double* __restrict  _ptr_array_Core_1_tau_pulse = _array_Core_1_tau_pulse;
    double*   _ptr_array_Core_1_I0 = _array_Core_1_I0;
    double* __restrict  _ptr_array_Core_1_alpha_ampa_std = _array_Core_1_alpha_ampa_std;
    double* __restrict  _ptr_array_Core_1_Va = _array_Core_1_Va;
    double* __restrict  _ptr_array_Core_1_lastspike = _array_Core_1_lastspike;
    double*   _ptr_array_Core_1_Csoma_mem = _array_Core_1_Csoma_mem;
    double*   _ptr_array_Core_1_kp = _array_Core_1_kp;
    double* __restrict  _ptr_array_Core_1_alpha_gaba_b = _array_Core_1_alpha_gaba_b;
    double* __restrict  _ptr_array_Core_1_Iampa = _array_Core_1_Iampa;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_Core_1_Igaba_b = _array_Core_1_Igaba_b;
    double* __restrict  _ptr_array_Core_1_alpha_gaba_a = _array_Core_1_alpha_gaba_a;
    double* __restrict  _ptr_array_Core_1_Cnmda = _array_Core_1_Cnmda;
    double* __restrict  _ptr_array_Core_1_alpha_soma = _array_Core_1_alpha_soma;
    double* __restrict  _ptr_array_Core_1_std_pulse = _array_Core_1_std_pulse;
    double* __restrict  _ptr_array_Core_1_Inmda = _array_Core_1_Inmda;
    double*   _ptr_array_Core_1_Csoma_ahp = _array_Core_1_Csoma_ahp;
    double* __restrict  _ptr_array_Core_1_Iampa_std_tau = _array_Core_1_Iampa_std_tau;
    double*   _ptr_array_Core_1_kn = _array_Core_1_kn;
    double* __restrict  _ptr_array_Core_1_Cgaba_a = _array_Core_1_Cgaba_a;
    double* __restrict  _ptr_array_Core_1_Campa = _array_Core_1_Campa;
    double* __restrict  _ptr_array_Core_1_Campa_std = _array_Core_1_Campa_std;
    double* __restrict  _ptr_array_Core_1_Iampa_tau = _array_Core_1_Iampa_tau;
    double*   _ptr_array_Core_1_Isoma_pfb_th = _array_Core_1_Isoma_pfb_th;
    double*   _ptr_array_Core_1_Isoma_dpi_tau = _array_Core_1_Isoma_dpi_tau;
    double* __restrict  _ptr_array_Core_1_Igaba_b_tau = _array_Core_1_Igaba_b_tau;
    double* __restrict  _ptr_array_Core_1_Iampa_std = _array_Core_1_Iampa_std;
    double* __restrict  _ptr_array_Core_1_Vw = _array_Core_1_Vw;
    double*   _ptr_array_Core_1_Isoma_ahp_tau = _array_Core_1_Isoma_ahp_tau;
    double* __restrict  _ptr_array_Core_1_alpha_nmda = _array_Core_1_alpha_nmda;
    double* __restrict  _ptr_array_Core_1_Inmda_tau = _array_Core_1_Inmda_tau;
    double* __restrict  _ptr_array_Core_1_alpha_ahp = _array_Core_1_alpha_ahp;
    double* __restrict  _ptr_array_Core_1_alpha_ampa = _array_Core_1_alpha_ampa;
    double*   _ptr_array_Core_1_Ut = _array_Core_1_Ut;
    double* __restrict  _ptr_array_Core_1_Inmda_thr = _array_Core_1_Inmda_thr;
    double* __restrict  _ptr_array_Core_1_Idischarge_w = _array_Core_1_Idischarge_w;
    double*   _ptr_array_Core_1_Isoma_pfb_norm = _array_Core_1_Isoma_pfb_norm;
    double* __restrict  _ptr_array_Core_1_Cgaba_b = _array_Core_1_Cgaba_b;
    double* __restrict  _ptr_array_Core_1_Isoma_mem = _array_Core_1_Isoma_mem;
    double* __restrict  _ptr_array_Core_1_Igaba_a_tau = _array_Core_1_Igaba_a_tau;
    ...
    const double Isoma_pfb_th = _ptr_array_Core_1_Isoma_pfb_th[0];
    const double dt = _ptr_array_defaultclock_dt[0];
    const double Isoma_dpi_tau = _ptr_array_Core_1_Isoma_dpi_tau[0];
    const double Isoma_pfb_gain = _ptr_array_Core_1_Isoma_pfb_gain[0];
    const double soma_refP = _ptr_array_Core_1_soma_refP[0];
    const double Ut = _ptr_array_Core_1_Ut[0];
    const double Csoma_ahp = _ptr_array_Core_1_Csoma_ahp[0];
    ...
    const double Csoma_mem = _ptr_array_Core_1_Csoma_mem[0];
    const double Isoma_pfb_norm = _ptr_array_Core_1_Isoma_pfb_norm[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double Igaba_a = _ptr_array_Core_1_Igaba_a[_idx];
        char not_refractory = _ptr_array_Core_1_not_refractory[_idx];
        const double Isoma_const = _ptr_array_Core_1_Isoma_const[_idx];
        const double tau_pulse = _ptr_array_Core_1_tau_pulse[_idx];
        const double alpha_ampa_std = _ptr_array_Core_1_alpha_ampa_std[_idx];
        const double Va = _ptr_array_Core_1_Va[_idx];
        const double lastspike = _ptr_array_Core_1_lastspike[_idx];
        const double alpha_gaba_b = _ptr_array_Core_1_alpha_gaba_b[_idx];
        double Iampa = _ptr_array_Core_1_Iampa[_idx];
        double Igaba_b = _ptr_array_Core_1_Igaba_b[_idx];
        const double alpha_gaba_a = _ptr_array_Core_1_alpha_gaba_a[_idx];
        const double Cnmda = _ptr_array_Core_1_Cnmda[_idx];
        const double alpha_soma = _ptr_array_Core_1_alpha_soma[_idx];
        double Inmda = _ptr_array_Core_1_Inmda[_idx];
        const double Iampa_std_tau = _ptr_array_Core_1_Iampa_std_tau[_idx];
        const double Cgaba_a = _ptr_array_Core_1_Cgaba_a[_idx];
        const double Campa = _ptr_array_Core_1_Campa[_idx];
        const double Campa_std = _ptr_array_Core_1_Campa_std[_idx];
        const double Iampa_tau = _ptr_array_Core_1_Iampa_tau[_idx];
        const double Igaba_b_tau = _ptr_array_Core_1_Igaba_b_tau[_idx];
        double Iampa_std = _ptr_array_Core_1_Iampa_std[_idx];
        double Vw = _ptr_array_Core_1_Vw[_idx];
        const double alpha_nmda = _ptr_array_Core_1_alpha_nmda[_idx];
        const double Inmda_tau = _ptr_array_Core_1_Inmda_tau[_idx];
        const double alpha_ahp = _ptr_array_Core_1_alpha_ahp[_idx];
        const double alpha_ampa = _ptr_array_Core_1_alpha_ampa[_idx];
        const double Inmda_thr = _ptr_array_Core_1_Inmda_thr[_idx];
        const double Idischarge_w = _ptr_array_Core_1_Idischarge_w[_idx];
        const double Igaba_a_tau = _ptr_array_Core_1_Igaba_a_tau[_idx];
        const double Cgaba_b = _ptr_array_Core_1_Cgaba_b[_idx];
        double Isoma_mem = _ptr_array_Core_1_Isoma_mem[_idx];
        double std_pulse = _ptr_array_Core_1_std_pulse[_idx];
        ...
        _ptr_array_Core_1_Iampa_std[_idx] = Iampa_std;
        _ptr_array_Core_1_Igaba_a[_idx] = Igaba_a;
        _ptr_array_Core_1_not_refractory[_idx] = not_refractory;
        _ptr_array_Core_1_Igaba_b[_idx] = Igaba_b;
        _ptr_array_Core_1_Vw[_idx] = Vw;
        _ptr_array_Core_1_Inmda[_idx] = Inmda;
        _ptr_array_Core_1_Isoma_mem[_idx] = Isoma_mem;
        _ptr_array_Core_1_std_pulse[_idx] = std_pulse;
        _ptr_array_Core_1_Iampa[_idx] = Iampa;
