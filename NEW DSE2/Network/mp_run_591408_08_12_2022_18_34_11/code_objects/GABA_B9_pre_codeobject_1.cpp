...
void _run_GABA_B9_pre_codeobject_1()
{
...
const size_t _num_postsynaptic_idx = _dynamic_array_GABA_B9__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_Core_3_Igaba_b_w0 = _array_Core_3_Igaba_b_w0;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double Igaba_b_w0_post = _ptr_array_Core_3_Igaba_b_w0[_postsynaptic_idx];
            double Igaba_b_post = _ptr_array_Core_3_Igaba_b[_postsynaptic_idx];
            const double weight = _ptr_array_GABA_B9_weight[_idx];
            const double alpha_gaba_b_post = _ptr_array_Core_3_alpha_gaba_b[_postsynaptic_idx];
            Igaba_b_post += (Igaba_b_w0_post * weight) * alpha_gaba_b_post;
            _ptr_array_Core_3_Igaba_b[_postsynaptic_idx] = Igaba_b_post;
...
void _debugmsg_GABA_B9_pre_codeobject_1()
{
    using namespace brian;
