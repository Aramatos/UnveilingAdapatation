...
#include "code_objects/AMPA2_post_codeobject_1.h"
...
#include "code_objects/AMPA3_post_codeobject_1.h"
...
#include "code_objects/AMPA_STD8_post_codeobject_1.h"
...
int main(int argc, char **argv)
{
...

	{
        ...
        network_1.add(&defaultclock, _run_SpikeGenerator_codeobject_1);
        ...
        network_1.add(&defaultclock, _run_AMPA2_pre_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA3_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA3_pre_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA7_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA7_pre_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA_STD1_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD1_pre_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA_STD8_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD8_pre_codeobject_1);
        network_1.add(&defaultclock, _run_GABA_B10_pre_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B10_pre_codeobject_1);
        ...
        network_1.add(&defaultclock, _run_AMPA2_post_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA3_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA3_post_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA7_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA7_post_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA_STD1_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD1_post_codeobject_1);
        network_1.add(&defaultclock, _run_AMPA_STD8_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA_STD8_post_codeobject_1);
        network_1.add(&defaultclock, _run_GABA_B10_post_push_spikes);
        network_1.add(&defaultclock, _run_GABA_B10_post_codeobject_1);
        ...
        #ifdef DEBUG
        _debugmsg_AMPA2_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA3_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA7_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD1_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD8_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B10_pre_codeobject_1();
        #endif
        ...
        #ifdef DEBUG
        _debugmsg_AMPA2_post_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA3_post_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA7_post_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD1_post_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA_STD8_post_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_GABA_B10_post_codeobject_1();
        #endif
