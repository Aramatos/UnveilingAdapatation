...
const int _num__static_array__dynamic_array_SpikeGenerator__timebins = 13;
double * _static_array__dynamic_array_SpikeGenerator_neuron_index;
const int _num__static_array__dynamic_array_SpikeGenerator_neuron_index = 13;
int64_t * _static_array__dynamic_array_SpikeGenerator_spike_number;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_number = 13;
double * _static_array__dynamic_array_SpikeGenerator_spike_time;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_time = 13;
...
void _init_arrays()
{
	...
	_dynamic_array_SpikeGenerator__timebins.resize(13);
    
	for(int i=0; i<13; i++) _dynamic_array_SpikeGenerator__timebins[i] = 0;
	...
	// static arrays
	_static_array__dynamic_array_SpikeGenerator__timebins = new int32_t[13];
	_static_array__dynamic_array_SpikeGenerator_neuron_index = new double[13];
	_static_array__dynamic_array_SpikeGenerator_spike_number = new int64_t[13];
	_static_array__dynamic_array_SpikeGenerator_spike_time = new double[13];
...
void _load_arrays()
{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator__timebins.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator__timebins), 13*sizeof(int32_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_neuron_index.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_neuron_index), 13*sizeof(double));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_number.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_number), 13*sizeof(int64_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_time.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_time), 13*sizeof(double));
	} else
	{
...
void _write_arrays()
{
	...
	outfile__array_Core_1_subgroup_5__sub_idx.open("results/_array_Core_1_subgroup_5__sub_idx_4850838472214909745", ios::binary | ios::out);
