...
const size_t _num_source_Inmda = 256;
...
const size_t _num_postsynaptic_idx = _dynamic_array_NMDA0__synaptic_post.size();
    ...
    _dynamic_array_statemonitor_Inmda.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_Inmda = _ptr_array_Core_1_Inmda[_postsynaptic_idx];
        const double _to_record_Inmda = _source_Inmda;


        _dynamic_array_statemonitor_Inmda(_new_size-1, _i) = _to_record_Inmda;
    }
