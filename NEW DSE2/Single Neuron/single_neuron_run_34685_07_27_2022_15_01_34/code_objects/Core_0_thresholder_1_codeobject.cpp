...
void _run_Core_0_thresholder_1_codeobject()
{
...
const size_t _numt = 1;
    ...
    double*   _ptr_array_Core_0_Isoma_th = _array_Core_0_Isoma_th;
    ...
    const double Isoma_th = _ptr_array_Core_0_Isoma_th[0];
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double Isoma_mem = _ptr_array_Core_0_Isoma_mem[_idx];
