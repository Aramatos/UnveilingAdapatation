...
const size_t _numnot_refractory = 256;
    ...
    double*   _ptr_array_Core_2_Isoma_reset = _array_Core_2_Isoma_reset;
    double* __restrict  _ptr_array_Core_2_Isoma_ahp_w = _array_Core_2_Isoma_ahp_w;
 ...
 const double Isoma_reset = _ptr_array_Core_2_Isoma_reset[0];
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        const double Isoma_ahp_w = _ptr_array_Core_2_Isoma_ahp_w[_idx];
