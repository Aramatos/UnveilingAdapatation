...
void _run_Core_1_thresholder_1_codeobject()
{
...
const size_t _numt = 1;
    ...
    double*   _ptr_array_Core_1_Isoma_th = _array_Core_1_Isoma_th;
    ...
    const double Isoma_th = _ptr_array_Core_1_Isoma_th[0];
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double Isoma_mem = _ptr_array_Core_1_Isoma_mem[_idx];
        ...
        if(_cond) {
            _ptr_array_Core_1__spikespace[_count++] = _idx;
            _ptr_array_Core_1_not_refractory[_idx] = false;
            _ptr_array_Core_1_lastspike[_idx] = _ptr_array_defaultclock_t[0];
        }
    }
    _ptr_array_Core_1__spikespace[N] = _count;
