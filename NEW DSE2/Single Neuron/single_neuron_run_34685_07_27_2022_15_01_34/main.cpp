...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(18);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(18);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(18);
        ...
        network_1.add(&defaultclock, _run_SpikeGenerator_codeobject_3);
        network_1.add(&defaultclock, _run_mon_neuron_input_codeobject);
        network_1.add(&defaultclock, _run_mon_neuron_output_codeobject_3);
        network_1.add(&defaultclock, _run_AMPA1_pre_push_spikes);
        network_1.add(&defaultclock, _run_AMPA1_pre_codeobject_3);
        network_1.add(&defaultclock, _run_NMDA0_pre_push_spikes);
        network_1.add(&defaultclock, _run_NMDA0_pre_codeobject);
        network_1.add(&defaultclock, _run_AMPA1_post_push_spikes);
        network_1.add(&defaultclock, _run_AMPA1_post_codeobject_3);
        network_1.add(&defaultclock, _run_NMDA0_post_push_spikes);
        network_1.add(&defaultclock, _run_NMDA0_post_codeobject_1);
        ...
        #ifdef DEBUG
        _debugmsg_AMPA1_pre_codeobject_3();
        #endif
        ...
        #ifdef DEBUG
        _debugmsg_AMPA1_post_codeobject_3();
        #endif
