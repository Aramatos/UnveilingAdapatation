...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(24);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(24);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(24);
        ...
        network.add(&defaultclock, _run_SpikeGenerator_codeobject_4);
        ...
        network.add(&defaultclock, _run_AMPA1_pre_codeobject_4);
        ...
        network.add(&defaultclock, _run_AMPA1_post_codeobject_4);
