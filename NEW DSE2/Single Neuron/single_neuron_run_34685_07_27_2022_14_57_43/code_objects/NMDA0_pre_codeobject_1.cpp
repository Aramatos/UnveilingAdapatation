...
const size_t _numInmda_w0_post = 256;
const size_t _numalpha_nmda_post = 256;
...
const size_t _num_postsynaptic_idx = _dynamic_array_NMDA0__synaptic_post.size();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double alpha_nmda_post = _ptr_array_Core_1_alpha_nmda[_postsynaptic_idx];
            const double Inmda_w0_post = _ptr_array_Core_1_Inmda_w0[_postsynaptic_idx];
