...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(31);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(31);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(31);
        ...
        network.add(&defaultclock, _run_SpikeGenerator_codeobject_6);
        ...
        network.add(&defaultclock, _run_AMPA1_pre_codeobject_6);
        network.add(&defaultclock, _run_NMDA0_pre_push_spikes);
        network.add(&defaultclock, _run_NMDA0_pre_codeobject_3);
        network.add(&defaultclock, _run_AMPA1_post_push_spikes);
        network.add(&defaultclock, _run_AMPA1_post_codeobject_6);
        network.add(&defaultclock, _run_NMDA0_post_push_spikes);
        network.add(&defaultclock, _run_NMDA0_post_codeobject_3);
        ...
        #ifdef DEBUG
        _debugmsg_AMPA1_pre_codeobject_6();
        #endif
        
        #ifdef DEBUG
        _debugmsg_NMDA0_pre_codeobject_3();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA1_post_codeobject_6();
        #endif
        
        #ifdef DEBUG
        _debugmsg_NMDA0_post_codeobject_3();
        #endif
