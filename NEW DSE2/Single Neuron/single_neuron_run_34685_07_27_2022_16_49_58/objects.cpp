...
const int _num__static_array__dynamic_array_SpikeGenerator__timebins = 31;
double * _static_array__dynamic_array_SpikeGenerator_neuron_index;
const int _num__static_array__dynamic_array_SpikeGenerator_neuron_index = 31;
int64_t * _static_array__dynamic_array_SpikeGenerator_spike_number;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_number = 31;
double * _static_array__dynamic_array_SpikeGenerator_spike_time;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_time = 31;
...
void _init_arrays()
{
	...
	_dynamic_array_SpikeGenerator__timebins.resize(31);
    
	for(int i=0; i<31; i++) _dynamic_array_SpikeGenerator__timebins[i] = 0;
	...
	for(int i=0; i<1; i++) _array_Core_1_subgroup_6__sub_idx[i] = 0 + i;
	...
	// static arrays
	_static_array__dynamic_array_SpikeGenerator__timebins = new int32_t[31];
	_static_array__dynamic_array_SpikeGenerator_neuron_index = new double[31];
	_static_array__dynamic_array_SpikeGenerator_spike_number = new int64_t[31];
	_static_array__dynamic_array_SpikeGenerator_spike_time = new double[31];
...
void _load_arrays()
{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator__timebins.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator__timebins), 31*sizeof(int32_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_neuron_index.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_neuron_index), 31*sizeof(double));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_number.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_number), 31*sizeof(int64_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_time.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_time), 31*sizeof(double));
	} else
	{
...
void _write_arrays()
{
	...
	outfile__array_Core_1_subgroup_6__sub_idx.open("results/_array_Core_1_subgroup_6__sub_idx_-6835941052852560054", ios::binary | ios::out);
