...
const int _num__static_array__dynamic_array_SpikeGenerator__timebins = 19;
double * _static_array__dynamic_array_SpikeGenerator_neuron_index;
const int _num__static_array__dynamic_array_SpikeGenerator_neuron_index = 19;
int64_t * _static_array__dynamic_array_SpikeGenerator_spike_number;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_number = 19;
double * _static_array__dynamic_array_SpikeGenerator_spike_time;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_time = 19;
...
void _init_arrays()
{
	...
	_dynamic_array_SpikeGenerator__timebins.resize(19);
    
	for(int i=0; i<19; i++) _dynamic_array_SpikeGenerator__timebins[i] = 0;
	...
	// static arrays
	_static_array__dynamic_array_SpikeGenerator__timebins = new int32_t[19];
	_static_array__dynamic_array_SpikeGenerator_neuron_index = new double[19];
	_static_array__dynamic_array_SpikeGenerator_spike_number = new int64_t[19];
	_static_array__dynamic_array_SpikeGenerator_spike_time = new double[19];
...
void _load_arrays()
{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator__timebins.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator__timebins), 19*sizeof(int32_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_neuron_index.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_neuron_index), 19*sizeof(double));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_number.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_number), 19*sizeof(int64_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_time.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_time), 19*sizeof(double));
	} else
	{
