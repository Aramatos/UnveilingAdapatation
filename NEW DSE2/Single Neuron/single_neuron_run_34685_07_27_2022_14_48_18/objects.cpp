...
double * _array_statemonitor_4_Isoma_mem;
const int _num__array_statemonitor_4_Isoma_mem = (0, 1);
...
DynamicArray2D<double> _dynamic_array_statemonitor_4_Isoma_mem;
DynamicArray2D<double> _dynamic_array_statemonitor_Inmda;

/////////////// static arrays /////////////
int32_t * _static_array__dynamic_array_SpikeGenerator__timebins;
const int _num__static_array__dynamic_array_SpikeGenerator__timebins = 14;
double * _static_array__dynamic_array_SpikeGenerator_neuron_index;
const int _num__static_array__dynamic_array_SpikeGenerator_neuron_index = 14;
int64_t * _static_array__dynamic_array_SpikeGenerator_spike_number;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_number = 14;
double * _static_array__dynamic_array_SpikeGenerator_spike_time;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_time = 14;
...
void _init_arrays()
{
	...
	_dynamic_array_SpikeGenerator__timebins.resize(14);
    
	for(int i=0; i<14; i++) _dynamic_array_SpikeGenerator__timebins[i] = 0;
	...
	for(int i=0; i<1; i++) _array_Core_1_subgroup_2__sub_idx[i] = 0 + i;
	...
	// static arrays
	_static_array__dynamic_array_SpikeGenerator__timebins = new int32_t[14];
	_static_array__dynamic_array_SpikeGenerator_neuron_index = new double[14];
	_static_array__dynamic_array_SpikeGenerator_spike_number = new int64_t[14];
	_static_array__dynamic_array_SpikeGenerator_spike_time = new double[14];
...
void _load_arrays()
{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator__timebins.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator__timebins), 14*sizeof(int32_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_neuron_index.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_neuron_index), 14*sizeof(double));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_number.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_number), 14*sizeof(int64_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_time.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_time), 14*sizeof(double));
	} else
	{
...
void _write_arrays()
{
	...
	outfile__array_Core_1_subgroup_2__sub_idx.open("results/_array_Core_1_subgroup_2__sub_idx_-3674656514327215647", ios::binary | ios::out);
	...
	outfile__dynamic_array_statemonitor_3_Iampa.open("results/_dynamic_array_statemonitor_3_Iampa_-422189638404748290", ios::binary | ios::out);
	...
	ofstream outfile__dynamic_array_statemonitor_4_Isoma_mem;
	outfile__dynamic_array_statemonitor_4_Isoma_mem.open("results/_dynamic_array_statemonitor_4_Isoma_mem_-7833400948255500950", ios::binary | ios::out);
	if(outfile__dynamic_array_statemonitor_4_Isoma_mem.is_open())
	{
        for (int n=0; n<_dynamic_array_statemonitor_4_Isoma_mem.n; n++)
        {
            if (! _dynamic_array_statemonitor_4_Isoma_mem(n).empty())
            {
                outfile__dynamic_array_statemonitor_4_Isoma_mem.write(reinterpret_cast<char*>(&_dynamic_array_statemonitor_4_Isoma_mem(n, 0)), _dynamic_array_statemonitor_4_Isoma_mem.m*sizeof(_dynamic_array_statemonitor_4_Isoma_mem(0, 0)));
            }
        }
        outfile__dynamic_array_statemonitor_4_Isoma_mem.close();
	} else
	{
		std::cout << "Error writing output file for _dynamic_array_statemonitor_4_Isoma_mem." << endl;
	}
