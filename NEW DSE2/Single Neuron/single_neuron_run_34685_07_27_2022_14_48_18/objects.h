...
extern double *_array_statemonitor_4_Isoma_mem;
extern const int _num__array_statemonitor_4_Isoma_mem;
...
extern DynamicArray2D<double> _dynamic_array_statemonitor_4_Isoma_mem;
