...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(14);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(14);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(14);
        ...
        network.add(&defaultclock, _run_SpikeGenerator_codeobject_2);
        network.add(&defaultclock, _run_mon_neuron_input_codeobject);
        network.add(&defaultclock, _run_mon_neuron_output_codeobject_2);
        network.add(&defaultclock, _run_AMPA1_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA1_pre_codeobject_2);
        ...
        network.add(&defaultclock, _run_AMPA1_post_codeobject_2);
        ...
        #ifdef DEBUG
        _debugmsg_mon_neuron_output_codeobject_2();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA1_pre_codeobject_2();
        #endif
        ...
        #ifdef DEBUG
        _debugmsg_AMPA1_post_codeobject_2();
        #endif
