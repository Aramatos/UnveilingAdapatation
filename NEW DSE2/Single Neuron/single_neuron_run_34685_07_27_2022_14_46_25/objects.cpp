...
double * _array_statemonitor_1_Iampa;
const int _num__array_statemonitor_1_Iampa = (0, 1);
...
//////////////// dynamic arrays 2d /////////
DynamicArray2D<double> _dynamic_array_statemonitor_1_Iampa;
...
const int _num__static_array__dynamic_array_SpikeGenerator__timebins = 16;
double * _static_array__dynamic_array_SpikeGenerator_neuron_index;
const int _num__static_array__dynamic_array_SpikeGenerator_neuron_index = 16;
int64_t * _static_array__dynamic_array_SpikeGenerator_spike_number;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_number = 16;
double * _static_array__dynamic_array_SpikeGenerator_spike_time;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_time = 16;
...
void _init_arrays()
{
	...
	_dynamic_array_SpikeGenerator__timebins.resize(16);
    
	for(int i=0; i<16; i++) _dynamic_array_SpikeGenerator__timebins[i] = 0;
	...
	// static arrays
	_static_array__dynamic_array_SpikeGenerator__timebins = new int32_t[16];
	_static_array__dynamic_array_SpikeGenerator_neuron_index = new double[16];
	_static_array__dynamic_array_SpikeGenerator_spike_number = new int64_t[16];
	_static_array__dynamic_array_SpikeGenerator_spike_time = new double[16];
...
void _load_arrays()
{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator__timebins.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator__timebins), 16*sizeof(int32_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_neuron_index.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_neuron_index), 16*sizeof(double));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_number.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_number), 16*sizeof(int64_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_time.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_time), 16*sizeof(double));
	} else
	{
...
void _write_arrays()
{
	...
	outfile__array_Core_1_subgroup__sub_idx.open("results/_array_Core_1_subgroup__sub_idx_689981306642248199", ios::binary | ios::out);
	...
	outfile__array_statemonitor_1__indices.open("results/_array_statemonitor_1__indices_3456597220120000151", ios::binary | ios::out);
	...
	outfile__array_statemonitor_1_N.open("results/_array_statemonitor_1_N_6791808423256922192", ios::binary | ios::out);
	...
	outfile__dynamic_array_statemonitor_1_t.open("results/_dynamic_array_statemonitor_1_t_-9111212148978754428", ios::binary | ios::out);
	...
	ofstream outfile__dynamic_array_statemonitor_1_Iampa;
	outfile__dynamic_array_statemonitor_1_Iampa.open("results/_dynamic_array_statemonitor_1_Iampa_-6301761774922752804", ios::binary | ios::out);
	if(outfile__dynamic_array_statemonitor_1_Iampa.is_open())
	{
        for (int n=0; n<_dynamic_array_statemonitor_1_Iampa.n; n++)
        {
            if (! _dynamic_array_statemonitor_1_Iampa(n).empty())
            {
                outfile__dynamic_array_statemonitor_1_Iampa.write(reinterpret_cast<char*>(&_dynamic_array_statemonitor_1_Iampa(n, 0)), _dynamic_array_statemonitor_1_Iampa.m*sizeof(_dynamic_array_statemonitor_1_Iampa(0, 0)));
            }
        }
        outfile__dynamic_array_statemonitor_1_Iampa.close();
	} else
	{
		std::cout << "Error writing output file for _dynamic_array_statemonitor_1_Iampa." << endl;
	}
	ofstream outfile__dynamic_array_statemonitor_2_Isoma_mem;
	outfile__dynamic_array_statemonitor_2_Isoma_mem.open("results/_dynamic_array_statemonitor_2_Isoma_mem_5022852774298299734", ios::binary | ios::out);
