...
double * _array_statemonitor_2_Iampa;
const int _num__array_statemonitor_2_Iampa = (0, 1);
...
double * _array_statemonitor_3_Isoma_mem;
const int _num__array_statemonitor_3_Isoma_mem = (0, 1);
...
//////////////// dynamic arrays 2d /////////
DynamicArray2D<double> _dynamic_array_statemonitor_2_Iampa;
DynamicArray2D<double> _dynamic_array_statemonitor_3_Isoma_mem;
DynamicArray2D<double> _dynamic_array_statemonitor_Inmda;

/////////////// static arrays /////////////
int32_t * _static_array__dynamic_array_SpikeGenerator__timebins;
const int _num__static_array__dynamic_array_SpikeGenerator__timebins = 11;
double * _static_array__dynamic_array_SpikeGenerator_neuron_index;
const int _num__static_array__dynamic_array_SpikeGenerator_neuron_index = 11;
int64_t * _static_array__dynamic_array_SpikeGenerator_spike_number;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_number = 11;
double * _static_array__dynamic_array_SpikeGenerator_spike_time;
const int _num__static_array__dynamic_array_SpikeGenerator_spike_time = 11;
...
void _init_arrays()
{
	...
	_dynamic_array_SpikeGenerator__timebins.resize(11);
    
	for(int i=0; i<11; i++) _dynamic_array_SpikeGenerator__timebins[i] = 0;
	...
	// static arrays
	_static_array__dynamic_array_SpikeGenerator__timebins = new int32_t[11];
	_static_array__dynamic_array_SpikeGenerator_neuron_index = new double[11];
	_static_array__dynamic_array_SpikeGenerator_spike_number = new int64_t[11];
	_static_array__dynamic_array_SpikeGenerator_spike_time = new double[11];
...
void _load_arrays()
{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator__timebins.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator__timebins), 11*sizeof(int32_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_neuron_index.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_neuron_index), 11*sizeof(double));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_number.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_number), 11*sizeof(int64_t));
	} else
	{
	...
	{
		f_static_array__dynamic_array_SpikeGenerator_spike_time.read(reinterpret_cast<char*>(_static_array__dynamic_array_SpikeGenerator_spike_time), 11*sizeof(double));
	} else
	{
...
void _write_arrays()
{
	...
	outfile__array_Core_1_subgroup_1__sub_idx.open("results/_array_Core_1_subgroup_1__sub_idx_416912599135214772", ios::binary | ios::out);
	...
	outfile__array_statemonitor_2__indices.open("results/_array_statemonitor_2__indices_8884760280189585399", ios::binary | ios::out);
	...
	outfile__array_statemonitor_2_N.open("results/_array_statemonitor_2_N_8374950973533649135", ios::binary | ios::out);
	...
	outfile__array_statemonitor_3__indices.open("results/_array_statemonitor_3__indices_3914977622214027522", ios::binary | ios::out);
	...
	outfile__array_statemonitor_3_N.open("results/_array_statemonitor_3_N_626589605932809818", ios::binary | ios::out);
	...
	outfile__dynamic_array_statemonitor_2_t.open("results/_dynamic_array_statemonitor_2_t_-6409957681982514227", ios::binary | ios::out);
	...
	outfile__dynamic_array_statemonitor_3_t.open("results/_dynamic_array_statemonitor_3_t_2083020601527826164", ios::binary | ios::out);
	...
	ofstream outfile__dynamic_array_statemonitor_2_Iampa;
	outfile__dynamic_array_statemonitor_2_Iampa.open("results/_dynamic_array_statemonitor_2_Iampa_-4076262051806649076", ios::binary | ios::out);
	if(outfile__dynamic_array_statemonitor_2_Iampa.is_open())
	{
        for (int n=0; n<_dynamic_array_statemonitor_2_Iampa.n; n++)
        {
            if (! _dynamic_array_statemonitor_2_Iampa(n).empty())
            {
                outfile__dynamic_array_statemonitor_2_Iampa.write(reinterpret_cast<char*>(&_dynamic_array_statemonitor_2_Iampa(n, 0)), _dynamic_array_statemonitor_2_Iampa.m*sizeof(_dynamic_array_statemonitor_2_Iampa(0, 0)));
            }
        }
        outfile__dynamic_array_statemonitor_2_Iampa.close();
	} else
	{
		std::cout << "Error writing output file for _dynamic_array_statemonitor_2_Iampa." << endl;
	}
	ofstream outfile__dynamic_array_statemonitor_3_Isoma_mem;
	outfile__dynamic_array_statemonitor_3_Isoma_mem.open("results/_dynamic_array_statemonitor_3_Isoma_mem_-2980696327709469904", ios::binary | ios::out);
	if(outfile__dynamic_array_statemonitor_3_Isoma_mem.is_open())
	{
        for (int n=0; n<_dynamic_array_statemonitor_3_Isoma_mem.n; n++)
        {
            if (! _dynamic_array_statemonitor_3_Isoma_mem(n).empty())
            {
                outfile__dynamic_array_statemonitor_3_Isoma_mem.write(reinterpret_cast<char*>(&_dynamic_array_statemonitor_3_Isoma_mem(n, 0)), _dynamic_array_statemonitor_3_Isoma_mem.m*sizeof(_dynamic_array_statemonitor_3_Isoma_mem(0, 0)));
            }
        }
        outfile__dynamic_array_statemonitor_3_Isoma_mem.close();
	} else
	{
		std::cout << "Error writing output file for _dynamic_array_statemonitor_3_Isoma_mem." << endl;
	}
