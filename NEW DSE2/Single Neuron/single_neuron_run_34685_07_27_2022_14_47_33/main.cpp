...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(11);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(11);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(11);
        ...
        _run_NMDA0_synapses_create_generator_codeobject();
                        ...
                        {
                            _dynamic_array_NMDA0_weight[i] = 1;
                        }
        ...
        network.add(&defaultclock, _run_mon_neuron_output_codeobject_1);
        network.add(&defaultclock, _run_AMPA1_pre_push_spikes);
        network.add(&defaultclock, _run_AMPA1_pre_codeobject_1);
        network.add(&defaultclock, _run_NMDA0_pre_push_spikes);
        network.add(&defaultclock, _run_NMDA0_pre_codeobject_1);
        network.add(&defaultclock, _run_AMPA1_post_push_spikes);
        network.add(&defaultclock, _run_AMPA1_post_codeobject_1);
        network.add(&defaultclock, _run_NMDA0_post_push_spikes);
        network.add(&defaultclock, _run_NMDA0_post_codeobject_1);
        ...
        #ifdef DEBUG
        _debugmsg_mon_neuron_output_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA1_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_NMDA0_pre_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_AMPA1_post_codeobject_1();
        #endif
        
        #ifdef DEBUG
        _debugmsg_NMDA0_post_codeobject_1();
        #endif
