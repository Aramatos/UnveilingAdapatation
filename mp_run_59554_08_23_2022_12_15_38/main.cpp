...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(1);
        _dynamic_array_SpikeGenerator_spike_number[0] = 0;
        _dynamic_array_SpikeGenerator_neuron_index.resize(1);
        _dynamic_array_SpikeGenerator_neuron_index[0] = 0.0;
        _dynamic_array_SpikeGenerator_spike_time.resize(1);
        _dynamic_array_SpikeGenerator_spike_time[0] = 0.0;
        ...
        _run_GABA_B10_synapses_create_generator_codeobject();
                        ...
                        {
                            _dynamic_array_AMPA0_weight[i] = 1.0;
                        }
                        ...
                        {
                            _dynamic_array_AMPA_STD1_weight[i] = 1.0;
                        }
                        ...
                        {
                            _dynamic_array_AMPA3_weight[i] = 1.0;
                        }
                        ...
                        {
                            _dynamic_array_GABA_B4_weight[i] = 1.0;
                        }
                        ...
                        {
                            _dynamic_array_GABA_B6_weight[i] = 1.0;
                        }
                        ...
                        {
                            _dynamic_array_AMPA_STD8_weight[i] = 2;
                        }
        ...
        _array_Core_2_Isoma_th[0] = 5e-09;
        ...
        _array_Core_3_Isoma_dpi_tau[0] = 3.5e-12;
        ...
        _array_Core_3_Isoma_th[0] = 5e-10;
        ...
        _array_Core_3_soma_refP[0] = 0.002;
                        ...
                        for(int i=0; i<_num__array_Core_1_Iampa_w0; i++)
                        {
                            _array_Core_1_Iampa_w0[i] = 2e-11;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_1_Igaba_b_tau; i++)
                        {
                            _array_Core_1_Igaba_b_tau[i] = 1e-12;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_1_Igaba_b_w0; i++)
                        {
                            _array_Core_1_Igaba_b_w0[i] = 4e-12;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_1_alpha_gaba_b; i++)
                        {
                            _array_Core_1_alpha_gaba_b[i] = 1;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_2_Iampa_tau; i++)
                        {
                            _array_Core_2_Iampa_tau[i] = 5e-12;
                        }
                        ...
                        for(int i=0; i<_num__array_Core_3_Iampa_w0; i++)
                        {
                            _array_Core_3_Iampa_w0[i] = 2e-11;
                        }
        ...
        _array_SpikeGenerator__lastindex[0] = 0;
        _dynamic_array_SpikeGenerator__timebins[0] = 0;
