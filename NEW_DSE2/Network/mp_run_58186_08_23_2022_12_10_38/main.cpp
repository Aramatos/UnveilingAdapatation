...
int main(int argc, char **argv)
{
...

	{
        ...
        _dynamic_array_SpikeGenerator_spike_number.resize(100);
        ...
        _dynamic_array_SpikeGenerator_neuron_index.resize(100);
        ...
        _dynamic_array_SpikeGenerator_spike_time.resize(100);
        ...
        _run_GABA_B10_synapses_create_generator_codeobject();
                        ...
                        {
                            _dynamic_array_AMPA0_weight[i] = 3;
                        }
                        ...
                        {
                            _dynamic_array_AMPA_STD1_weight[i] = 1;
                        }
                        ...
                        {
                            _dynamic_array_AMPA3_weight[i] = 1.1;
                        }
                        ...
                        {
                            _dynamic_array_GABA_B5_weight[i] = 5;
                        }
                        ...
                        {
                            _dynamic_array_GABA_B6_weight[i] = 2;
                        }
                        ...
                        {
                            _dynamic_array_GABA_B9_weight[i] = 2;
                        }
