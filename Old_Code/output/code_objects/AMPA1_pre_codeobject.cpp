...
void _run_AMPA1_pre_codeobject()
{
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA1__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_Core_3_I_wo_syn_ampa = _array_Core_3_I_wo_syn_ampa;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double I_wo_syn_ampa_post = _ptr_array_Core_3_I_wo_syn_ampa[_postsynaptic_idx];
            const double weight = _ptr_array_AMPA1_weight[_idx];
            double I_syn_ampa_post = _ptr_array_Core_3_I_syn_ampa[_postsynaptic_idx];
            const double I_g_syn_ampa_post = _ptr_array_Core_3_I_g_syn_ampa[_postsynaptic_idx];
            double D = _ptr_array_Core_3_D[_postsynaptic_idx];
            const double I_tau_syn_ampa_post = _ptr_array_Core_3_I_tau_syn_ampa[_postsynaptic_idx];
            D = ((D + d) * (D < 1)) + (1 * (D >= 1));
            ...
            _ptr_array_Core_3_I_syn_ampa[_postsynaptic_idx] = I_syn_ampa_post;
...
void _debugmsg_AMPA1_pre_codeobject()
{
    using namespace brian;
