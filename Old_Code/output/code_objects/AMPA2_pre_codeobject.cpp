...
double* const _array_AMPA2_d = _dynamic_array_AMPA2_d.empty()? 0 : &_dynamic_array_AMPA2_d[0];
const size_t _numd = _dynamic_array_AMPA2_d.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA2__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_AMPA2_d = _array_AMPA2_d;
    double* __restrict  _ptr_array_Core_2_I_wo_syn_ampa = _array_Core_2_I_wo_syn_ampa;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double d = _ptr_array_AMPA2_d[_idx];
            const double I_wo_syn_ampa_post = _ptr_array_Core_2_I_wo_syn_ampa[_postsynaptic_idx];
            const double weight = _ptr_array_AMPA2_weight[_idx];
            double I_syn_ampa_post = _ptr_array_Core_2_I_syn_ampa[_postsynaptic_idx];
            const double I_g_syn_ampa_post = _ptr_array_Core_2_I_g_syn_ampa[_postsynaptic_idx];
            double D = _ptr_array_Core_2_D[_postsynaptic_idx];
            const double I_tau_syn_ampa_post = _ptr_array_Core_2_I_tau_syn_ampa[_postsynaptic_idx];
            D = ((D + d) * (D < 1)) + (1 * (D >= 1));
            ...
            _ptr_array_Core_2_I_syn_ampa[_postsynaptic_idx] = I_syn_ampa_post;
