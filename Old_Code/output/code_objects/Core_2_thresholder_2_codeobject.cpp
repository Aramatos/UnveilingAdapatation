#include "code_objects/Core_2_thresholder_2_codeobject.h"
#include "objects.h"
...
void _run_Core_2_thresholder_2_codeobject()
{
...
const size_t _numnot_refractory = 256;
    ...
    const double Ispkthr = _ptr_array_Core_2_Ispkthr[0];
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double Imem = _ptr_array_Core_2_Imem[_idx];
    ...
    _ptr_array_Core_2__spikespace[N] = _count;
