#include "code_objects/AMPA0_pre_codeobject_15.h"
#include "objects.h"
...
void _run_AMPA0_pre_codeobject_15()
{
...
double* const _array_AMPA0_d = _dynamic_array_AMPA0_d.empty()? 0 : &_dynamic_array_AMPA0_d[0];
const size_t _numd = _dynamic_array_AMPA0_d.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA0__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_AMPA0_d = _array_AMPA0_d;
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA0_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double d = _ptr_array_AMPA0_d[_idx];
...
void _debugmsg_AMPA0_pre_codeobject_15()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_AMPA0__synaptic_pre.size() << endl;
}
