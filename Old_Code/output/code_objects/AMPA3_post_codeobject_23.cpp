#include "code_objects/AMPA3_post_codeobject_23.h"
#include "objects.h"
...
void _run_AMPA3_post_codeobject_23()
{
...
const size_t _num_synaptic_pre = _dynamic_array_AMPA3__synaptic_pre.size();
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA3_post.peek();
...
void _debugmsg_AMPA3_post_codeobject_23()
{
    using namespace brian;
