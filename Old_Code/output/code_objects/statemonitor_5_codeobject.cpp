...
const size_t _num_sub_idx = 4;
    ...
    int32_t* __restrict  _ptr_array_Core_1_subgroup_9__sub_idx = _array_Core_1_subgroup_9__sub_idx;
    ...
    _dynamic_array_statemonitor_5_Imem.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_Core_1_subgroup_9__sub_idx[_idx];
        const double _source_Imem = _ptr_array_Core_1_Imem[_sub_idx];
        const double _to_record_Imem = _source_Imem;


        _dynamic_array_statemonitor_5_Imem(_new_size-1, _i) = _to_record_Imem;
    }
