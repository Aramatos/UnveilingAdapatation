#include "code_objects/Core_1_stateupdater_2_codeobject.h"
#include "objects.h"
...
void _run_Core_1_stateupdater_2_codeobject()
{
...
const size_t _numI_tau_syn_nmda = 256;
    ...
    double*   _ptr_array_Core_1_M = _array_Core_1_M;
    ...
    const double M = _ptr_array_Core_1_M[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double D = _ptr_array_Core_1_D[_idx];
