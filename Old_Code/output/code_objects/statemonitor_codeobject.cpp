...
const size_t _num_source_D = 256;
...
const size_t _num_sub_idx = 1;
    ...
    int32_t*   _ptr_array_Core_1_subgroup_2__sub_idx = _array_Core_1_subgroup_2__sub_idx;
    ...
    _dynamic_array_statemonitor_D.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_D = _ptr_array_Core_1_D[_sub_idx];
        const double _to_record_D = _source_D;


        _dynamic_array_statemonitor_D(_new_size-1, _i) = _to_record_D;
    }
