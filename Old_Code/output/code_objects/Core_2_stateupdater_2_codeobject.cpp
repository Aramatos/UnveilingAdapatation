#include "code_objects/Core_2_stateupdater_2_codeobject.h"
#include "objects.h"
...
void _run_Core_2_stateupdater_2_codeobject()
{
...
const size_t _numI_tau_syn_nmda = 256;
    ...
    double* __restrict  _ptr_array_Core_2_I_syn_gaba_a = _array_Core_2_I_syn_gaba_a;
    double* __restrict  _ptr_array_Core_2_I_g_syn_nmda = _array_Core_2_I_g_syn_nmda;
    double*   _ptr_array_Core_2_Iagain = _array_Core_2_Iagain;
    double* __restrict  _ptr_array_Core_2_C_syn_gaba_a = _array_Core_2_C_syn_gaba_a;
    double*   _ptr_array_Core_2_kp = _array_Core_2_kp;
    double* __restrict  _ptr_array_Core_2_Imem = _array_Core_2_Imem;
    double*   _ptr_array_Core_2_Ith = _array_Core_2_Ith;
    double*   _ptr_array_Core_2_Io = _array_Core_2_Io;
    double* __restrict  _ptr_array_Core_2_I_g_syn_ampa = _array_Core_2_I_g_syn_ampa;
    double*   _ptr_array_Core_2_refP = _array_Core_2_refP;
    double*   _ptr_array_Core_2_Ut = _array_Core_2_Ut;
    double*   _ptr_array_Core_2_Cahp = _array_Core_2_Cahp;
    double* __restrict  _ptr_array_Core_2_C_syn_gaba_b = _array_Core_2_C_syn_gaba_b;
    double* __restrict  _ptr_array_Core_2_I_syn_gaba_b = _array_Core_2_I_syn_gaba_b;
    double* __restrict  _ptr_array_Core_2_Iahp = _array_Core_2_Iahp;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_Core_2_I_syn_nmda = _array_Core_2_I_syn_nmda;
    double*   _ptr_array_Core_2_Itau = _array_Core_2_Itau;
    char* __restrict  _ptr_array_Core_2_not_refractory = _array_Core_2_not_refractory;
    double* __restrict  _ptr_array_Core_2_I_tau_syn_gaba_a = _array_Core_2_I_tau_syn_gaba_a;
    double*   _ptr_array_Core_2_Itauahp = _array_Core_2_Itauahp;
    double*   _ptr_array_Core_2_Cmem = _array_Core_2_Cmem;
    double*   _ptr_array_defaultclock_t = _array_defaultclock_t;
    double* __restrict  _ptr_array_Core_2_I_g_syn_gaba_a = _array_Core_2_I_g_syn_gaba_a;
    double* __restrict  _ptr_array_Core_2_I_syn_ampa = _array_Core_2_I_syn_ampa;
    double*   _ptr_array_Core_2_M = _array_Core_2_M;
    double* __restrict  _ptr_array_Core_2_C_syn_ampa = _array_Core_2_C_syn_ampa;
    double* __restrict  _ptr_array_Core_2_I_tau_syn_ampa = _array_Core_2_I_tau_syn_ampa;
    ...
    double* __restrict  _ptr_array_Core_2_C_syn_nmda = _array_Core_2_C_syn_nmda;
    double*   _ptr_array_Core_2_Iath = _array_Core_2_Iath;
    double* __restrict  _ptr_array_Core_2_lastspike = _array_Core_2_lastspike;
    double*   _ptr_array_Core_2_Ithahp = _array_Core_2_Ithahp;
    double* __restrict  _ptr_array_Core_2_I_g_syn_gaba_b = _array_Core_2_I_g_syn_gaba_b;
    double*   _ptr_array_Core_2_Ianorm = _array_Core_2_Ianorm;
    double* __restrict  _ptr_array_Core_2_Iconst = _array_Core_2_Iconst;
    double* __restrict  _ptr_array_Core_2_D = _array_Core_2_D;
    double* __restrict  _ptr_array_Core_2_I_tau_syn_nmda = _array_Core_2_I_tau_syn_nmda;
    ...
    const double Cahp = _ptr_array_Core_2_Cahp[0];
    const double Cmem = _ptr_array_Core_2_Cmem[0];
    const double M = _ptr_array_Core_2_M[0];
    const double Itauahp = _ptr_array_Core_2_Itauahp[0];
    const double Iagain = _ptr_array_Core_2_Iagain[0];
    const double Ith = _ptr_array_Core_2_Ith[0];
    const double kp = _ptr_array_Core_2_kp[0];
    const double t = _ptr_array_defaultclock_t[0];
    const double Itau = _ptr_array_Core_2_Itau[0];
    const double kn = _ptr_array_Core_2_kn[0];
    const double dt = _ptr_array_defaultclock_dt[0];
    const double Iath = _ptr_array_Core_2_Iath[0];
    const double Ithahp = _ptr_array_Core_2_Ithahp[0];
    const double Io = _ptr_array_Core_2_Io[0];
    const double Ianorm = _ptr_array_Core_2_Ianorm[0];
    const double refP = _ptr_array_Core_2_refP[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double I_syn_gaba_a = _ptr_array_Core_2_I_syn_gaba_a[_idx];
        const double I_g_syn_nmda = _ptr_array_Core_2_I_g_syn_nmda[_idx];
        double Imem = _ptr_array_Core_2_Imem[_idx];
        const double C_syn_gaba_a = _ptr_array_Core_2_C_syn_gaba_a[_idx];
        const double I_g_syn_ampa = _ptr_array_Core_2_I_g_syn_ampa[_idx];
        const double C_syn_gaba_b = _ptr_array_Core_2_C_syn_gaba_b[_idx];
        double I_syn_gaba_b = _ptr_array_Core_2_I_syn_gaba_b[_idx];
        double Iahp = _ptr_array_Core_2_Iahp[_idx];
        double I_syn_nmda = _ptr_array_Core_2_I_syn_nmda[_idx];
        char not_refractory = _ptr_array_Core_2_not_refractory[_idx];
        const double I_tau_syn_gaba_a = _ptr_array_Core_2_I_tau_syn_gaba_a[_idx];
        const double I_g_syn_gaba_a = _ptr_array_Core_2_I_g_syn_gaba_a[_idx];
        double I_syn_ampa = _ptr_array_Core_2_I_syn_ampa[_idx];
        const double C_syn_ampa = _ptr_array_Core_2_C_syn_ampa[_idx];
        const double I_tau_syn_ampa = _ptr_array_Core_2_I_tau_syn_ampa[_idx];
        const double I_tau_syn_gaba_b = _ptr_array_Core_2_I_tau_syn_gaba_b[_idx];
        const double C_syn_nmda = _ptr_array_Core_2_C_syn_nmda[_idx];
        const double lastspike = _ptr_array_Core_2_lastspike[_idx];
        const double I_g_syn_gaba_b = _ptr_array_Core_2_I_g_syn_gaba_b[_idx];
        const double Iconst = _ptr_array_Core_2_Iconst[_idx];
        double D = _ptr_array_Core_2_D[_idx];
        const double I_tau_syn_nmda = _ptr_array_Core_2_I_tau_syn_nmda[_idx];
        ...
        if(not_refractory)
            Imem = _Imem;
        _ptr_array_Core_2_I_syn_gaba_a[_idx] = I_syn_gaba_a;
        _ptr_array_Core_2_I_syn_ampa[_idx] = I_syn_ampa;
        _ptr_array_Core_2_Iahp[_idx] = Iahp;
        _ptr_array_Core_2_Imem[_idx] = Imem;
        _ptr_array_Core_2_I_syn_gaba_b[_idx] = I_syn_gaba_b;
        _ptr_array_Core_2_I_syn_nmda[_idx] = I_syn_nmda;
        _ptr_array_Core_2_not_refractory[_idx] = not_refractory;
        _ptr_array_Core_2_D[_idx] = D;
