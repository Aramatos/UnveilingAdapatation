...
from brian2 import pF, ms, pA, nA, Hz
from parameters import constants


dynapse_param = {
    "ahp" : 0,                          # percentage of maximum strength of adaptation  
    "D" : 0,                            # Depression strength, D = 1 (no Depression)
    "taud" : 15 * ms,                   # Depression time constant
    "M" : 0 * Hz,                     # Depression rate, inversely proprortional to depression time constants
    ...
    "refP": 5 * ms,                   # Refractory period, limits maximum firing rate
