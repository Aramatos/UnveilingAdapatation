...
const size_t _num__source_i_Core_1_subgroup_15__source_i = 256;
const size_t _numcount = 1;
const size_t _num_clock_t = 1;
const int64_t __source_i_Core_1_subgroup_15__offset = 1;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_Core_1_subgroup_15__source_i = _ptr_array_Core_1_i[_idx];
                const double _to_record_t = _source_t;
                const int32_t _source_i = __source_i_Core_1_subgroup_15__source_i - __source_i_Core_1_subgroup_15__offset;
