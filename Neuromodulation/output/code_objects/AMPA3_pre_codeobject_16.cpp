#include "code_objects/AMPA3_pre_codeobject_16.h"
#include "objects.h"
...
void _run_AMPA3_pre_codeobject_16()
{
...
double* const _array_AMPA3_d = _dynamic_array_AMPA3_d.empty()? 0 : &_dynamic_array_AMPA3_d[0];
const size_t _numd = _dynamic_array_AMPA3_d.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA3__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_AMPA3_d = _array_AMPA3_d;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double d = _ptr_array_AMPA3_d[_idx];
...
void _debugmsg_AMPA3_pre_codeobject_16()
{
    using namespace brian;
