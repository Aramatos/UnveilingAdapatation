#include "code_objects/AMPA0_post_codeobject_13.h"
#include "objects.h"
...
void _run_AMPA0_post_codeobject_13()
{
...
const size_t _num_synaptic_pre = _dynamic_array_AMPA0__synaptic_pre.size();
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA0_post.peek();
...
void _debugmsg_AMPA0_post_codeobject_13()
{
    using namespace brian;
