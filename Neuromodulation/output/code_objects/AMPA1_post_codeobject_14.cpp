#include "code_objects/AMPA1_post_codeobject_14.h"
#include "objects.h"
...
void _run_AMPA1_post_codeobject_14()
{
...
const size_t _num_synaptic_pre = _dynamic_array_AMPA1__synaptic_pre.size();
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA1_post.peek();
...
void _debugmsg_AMPA1_post_codeobject_14()
{
    using namespace brian;
