#include "code_objects/Core_1_resetter_2_codeobject.h"
#include "objects.h"
...
void _run_Core_1_resetter_2_codeobject()
{
...
const size_t _numnot_refractory = 256;
    ...
    double*   _ptr_array_Core_1_Ireset = _array_Core_1_Ireset;
    double*   _ptr_array_Core_1_Ithahp = _array_Core_1_Ithahp;
    double*   _ptr_array_Core_1_Io = _array_Core_1_Io;
    double* __restrict  _ptr_array_Core_1_Ica = _array_Core_1_Ica;
	...
	const int32_t _num_events = _ptr_array_Core_1__spikespace[N];
 ...
 const double Ireset = _ptr_array_Core_1_Ireset[0];
 const double Io = _ptr_array_Core_1_Io[0];
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        const double Ica = _ptr_array_Core_1_Ica[_idx];
        double Imem;
        Imem = Ireset;
