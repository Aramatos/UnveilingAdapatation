#include "code_objects/AMPA2_post_codeobject_18.h"
#include "objects.h"
...
void _run_AMPA2_post_codeobject_18()
{
...
const size_t _num_synaptic_pre = _dynamic_array_AMPA2__synaptic_pre.size();
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA2_post.peek();
...
void _debugmsg_AMPA2_post_codeobject_18()
{
    using namespace brian;
