#include "objects.h"
#include "code_objects/after_run_Core_1_thresholder_2_codeobject.h"
...
_ptr_array_Core_1__spikespace[N] = 0;  // Note that this is not an off-by-1-error: the array has N+1 elements
