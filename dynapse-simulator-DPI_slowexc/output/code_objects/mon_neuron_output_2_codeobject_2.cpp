...
const size_t _num__source_i_Core_1_subgroup_12__source_i = 256;
const size_t _num_clock_t = 1;
const int64_t _source_stop = 2;
const int64_t __source_i_Core_1_subgroup_12__offset = 1;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_Core_1_subgroup_12__source_i = _ptr_array_Core_1_i[_idx];
                const int32_t _source_i = __source_i_Core_1_subgroup_12__source_i - __source_i_Core_1_subgroup_12__offset;
