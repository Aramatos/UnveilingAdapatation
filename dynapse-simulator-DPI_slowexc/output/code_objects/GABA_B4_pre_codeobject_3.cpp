#include "code_objects/GABA_B4_pre_codeobject_3.h"
#include "objects.h"
...
void _run_GABA_B4_pre_codeobject_3()
{
...
const size_t _num_postsynaptic_idx = _dynamic_array_GABA_B4__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_Core_3_I_wo_syn_gaba_b = _array_Core_3_I_wo_syn_gaba_b;
    ...
    {
    std::vector<int> *_spiking_synapses = GABA_B4_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double I_tau_syn_gaba_b_post = _ptr_array_Core_3_I_tau_syn_gaba_b[_postsynaptic_idx];
            const double I_g_syn_gaba_b_post = _ptr_array_Core_3_I_g_syn_gaba_b[_postsynaptic_idx];
            double I_syn_gaba_b_post = _ptr_array_Core_3_I_syn_gaba_b[_postsynaptic_idx];
            const double I_wo_syn_gaba_b_post = _ptr_array_Core_3_I_wo_syn_gaba_b[_postsynaptic_idx];
            ...
            _ptr_array_Core_3_I_syn_gaba_b[_postsynaptic_idx] = I_syn_gaba_b_post;
...
void _debugmsg_GABA_B4_pre_codeobject_3()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_GABA_B4__synaptic_pre.size() << endl;
}
