#include "code_objects/Core_0_stateupdater_2_codeobject.h"
#include "objects.h"
...
void _run_Core_0_stateupdater_2_codeobject()
{
...
const size_t _numIconst = 256;
    ...
    double* __restrict  _ptr_array_Core_0_Vnmda = _array_Core_0_Vnmda;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double Vnmda = _ptr_array_Core_0_Vnmda[_idx];
