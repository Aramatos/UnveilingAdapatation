...
void _run_PC_output_codeobject_1()
{
...
const size_t _numcount = 8;
const size_t _num_clock_t = 1;
const int64_t _source_stop = 8;
...
const size_t _num_source_idx = 8;
    ///// POINTERS ////////////
...
void _debugmsg_PC_output_codeobject_1()
{
    using namespace brian;
    const size_t _numN = 1;
const size_t _numcount = 8;
