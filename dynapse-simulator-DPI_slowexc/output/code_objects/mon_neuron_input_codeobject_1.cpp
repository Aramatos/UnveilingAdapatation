...
void _run_mon_neuron_input_codeobject_1()
{
...
const size_t _num_source_idx = 1;
    ...
    int32_t*   _ptr_array_poissongroup_42_i = _array_poissongroup_42_i;
    double*   _ptr_array_defaultclock_t = _array_defaultclock_t;
    int32_t* __restrict  _ptr_array_poissongroup_42__spikespace = _array_poissongroup_42__spikespace;
    ...
    int32_t _num_events = _ptr_array_poissongroup_42__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_poissongroup_42__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_poissongroup_42__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_poissongroup_42_i[_idx];
...
void _debugmsg_mon_neuron_input_codeobject_1()
{
    using namespace brian;
    double* const _array_mon_neuron_input_t = _dynamic_array_mon_neuron_input_t.empty()? 0 : &_dynamic_array_mon_neuron_input_t[0];
const size_t _numt = _dynamic_array_mon_neuron_input_t.size();
