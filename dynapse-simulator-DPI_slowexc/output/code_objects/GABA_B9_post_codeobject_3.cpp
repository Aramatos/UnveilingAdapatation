#include "code_objects/GABA_B9_post_codeobject_3.h"
#include "objects.h"
...
void _run_GABA_B9_post_codeobject_3()
{
...
const size_t _num_synaptic_pre = _dynamic_array_GABA_B9__synaptic_pre.size();
    ...
    {
    std::vector<int> *_spiking_synapses = GABA_B9_post.peek();
...
void _debugmsg_GABA_B9_post_codeobject_3()
{
    using namespace brian;
