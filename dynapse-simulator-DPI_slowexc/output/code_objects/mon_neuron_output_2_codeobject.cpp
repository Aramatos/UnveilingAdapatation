...
void _run_mon_neuron_output_2_codeobject()
{
    using namespace brian;


    ///// CONSTANTS ///////////
    const size_t _num__source_i_Core_1_subgroup_22__source_i = 256;
...
const int64_t __source_i_Core_1_subgroup_22__offset = 1;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_Core_1_subgroup_22__source_i = _ptr_array_Core_1_i[_idx];
                const int32_t _source_i = __source_i_Core_1_subgroup_22__source_i - __source_i_Core_1_subgroup_22__offset;
