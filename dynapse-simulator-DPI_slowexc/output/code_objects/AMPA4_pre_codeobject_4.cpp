#include "code_objects/AMPA4_pre_codeobject_4.h"
#include "objects.h"
...
void _run_AMPA4_pre_codeobject_4()
{
...
double* const _array_AMPA4_weight = _dynamic_array_AMPA4_weight.empty()? 0 : &_dynamic_array_AMPA4_weight[0];
const size_t _numweight = _dynamic_array_AMPA4_weight.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA4__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_AMPA4_weight = _array_AMPA4_weight;
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA4_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_AMPA4__synaptic_post[_idx];
            ...
            const double weight = _ptr_array_AMPA4_weight[_idx];
...
void _debugmsg_AMPA4_pre_codeobject_4()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_AMPA4__synaptic_pre.size() << endl;
}
