#include "code_objects/Core_0_thresholder_2_codeobject.h"
#include "objects.h"
...
void _run_Core_0_thresholder_2_codeobject()
{
...
const size_t _numlastspike = 256;
    ...
    double*   _ptr_array_Core_0_Ispkthr = _array_Core_0_Ispkthr;
    ...
    const double Ispkthr = _ptr_array_Core_0_Ispkthr[0];
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const double Imem = _ptr_array_Core_0_Imem[_idx];
        const char not_refractory = _ptr_array_Core_0_not_refractory[_idx];
        char _cond;
        if(!not_refractory)
        ...
        if(_cond) {
            _ptr_array_Core_0__spikespace[_count++] = _idx;
            _ptr_array_Core_0_not_refractory[_idx] = false;
            _ptr_array_Core_0_lastspike[_idx] = _ptr_array_defaultclock_t[0];
        }
    }
    _ptr_array_Core_0__spikespace[N] = _count;
