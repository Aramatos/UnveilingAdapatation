#include "code_objects/mon_neuron_output_2_codeobject_3.h"
#include "objects.h"
...
void _run_mon_neuron_output_2_codeobject_3()
{
...
const int64_t __source_i_Core_1_subgroup_25__offset = 1;
const size_t _num_spikespace = 257;
const size_t _num_source_t = 1;
const size_t _num__source_i_Core_1_subgroup_25__source_i = 256;
...
const size_t _num_source_idx = 1;
    ...
    int32_t*   _ptr_array_mon_neuron_output_2_count = _array_mon_neuron_output_2_count;
    int32_t*   _ptr_array_mon_neuron_output_2__source_idx = _array_mon_neuron_output_2__source_idx;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_Core_1_subgroup_25__source_i = _ptr_array_Core_1_i[_idx];
                const int32_t _source_i = __source_i_Core_1_subgroup_25__source_i - __source_i_Core_1_subgroup_25__offset;
                const int32_t _to_record_i = _source_i;
                const double _to_record_t = _source_t;

                _dynamic_array_mon_neuron_output_2_i.push_back(_to_record_i);
                _dynamic_array_mon_neuron_output_2_t.push_back(_to_record_t);
                _ptr_array_mon_neuron_output_2_count[_idx-_source_start]++;
            }
            _ptr_array_mon_neuron_output_2_N[0] += _num_events;
        }
    }
...
void _debugmsg_mon_neuron_output_2_codeobject_3()
{
    using namespace brian;
    double* const _array_mon_neuron_output_2_t = _dynamic_array_mon_neuron_output_2_t.empty()? 0 : &_dynamic_array_mon_neuron_output_2_t[0];
const size_t _numt = _dynamic_array_mon_neuron_output_2_t.size();
