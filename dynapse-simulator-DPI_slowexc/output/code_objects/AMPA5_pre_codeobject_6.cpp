#include "code_objects/AMPA5_pre_codeobject_6.h"
#include "objects.h"
...
void _run_AMPA5_pre_codeobject_6()
{
...
double* const _array_AMPA5_weight = _dynamic_array_AMPA5_weight.empty()? 0 : &_dynamic_array_AMPA5_weight[0];
const size_t _numweight = _dynamic_array_AMPA5_weight.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA5__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_AMPA5_weight = _array_AMPA5_weight;
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA5_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_AMPA5__synaptic_post[_idx];
            ...
            const double weight = _ptr_array_AMPA5_weight[_idx];
...
void _debugmsg_AMPA5_pre_codeobject_6()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_AMPA5__synaptic_pre.size() << endl;
}
