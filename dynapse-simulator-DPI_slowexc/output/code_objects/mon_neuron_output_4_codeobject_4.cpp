#include "code_objects/mon_neuron_output_4_codeobject_4.h"
#include "objects.h"
...
void _run_mon_neuron_output_4_codeobject_4()
{
...
const size_t _num__source_i_Core_1_subgroup_36__source_i = 256;
...
const int64_t __source_i_Core_1_subgroup_36__offset = 3;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_Core_1_subgroup_36__source_i = _ptr_array_Core_1_i[_idx];
                const int32_t _source_i = __source_i_Core_1_subgroup_36__source_i - __source_i_Core_1_subgroup_36__offset;
...
void _debugmsg_mon_neuron_output_4_codeobject_4()
{
    using namespace brian;
    double* const _array_mon_neuron_output_4_t = _dynamic_array_mon_neuron_output_4_t.empty()? 0 : &_dynamic_array_mon_neuron_output_4_t[0];
const size_t _numt = _dynamic_array_mon_neuron_output_4_t.size();
