#include "code_objects/mon_neuron_output_2_codeobject_1.h"
#include "objects.h"
...
void _run_mon_neuron_output_2_codeobject_1()
{
...
const int64_t __source_i_Core_1_subgroup_26__offset = 1;
...
void _debugmsg_mon_neuron_output_2_codeobject_1()
{
    using namespace brian;
    double* const _array_mon_neuron_output_2_t = _dynamic_array_mon_neuron_output_2_t.empty()? 0 : &_dynamic_array_mon_neuron_output_2_t[0];
const size_t _numt = _dynamic_array_mon_neuron_output_2_t.size();
