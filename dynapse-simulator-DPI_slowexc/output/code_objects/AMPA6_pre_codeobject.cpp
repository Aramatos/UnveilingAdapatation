#include "code_objects/AMPA6_pre_codeobject.h"
#include "objects.h"
...
void _run_AMPA6_pre_codeobject()
{
...
double* const _array_AMPA6_weight = _dynamic_array_AMPA6_weight.empty()? 0 : &_dynamic_array_AMPA6_weight[0];
const size_t _numweight = _dynamic_array_AMPA6_weight.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_AMPA6__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_AMPA6_weight = _array_AMPA6_weight;
    ...
    {
    std::vector<int> *_spiking_synapses = AMPA6_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_AMPA6__synaptic_post[_idx];
            const double weight = _ptr_array_AMPA6_weight[_idx];
...
void _debugmsg_AMPA6_pre_codeobject()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_AMPA6__synaptic_pre.size() << endl;
}
